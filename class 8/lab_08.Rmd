...
mingo <- read_tsv("arcos-wv-mingo-54059-itemized.tsv")
...
average_county_pills_per_year<- 'https://raw.githubusercontent.com/smussenden/spring20-data-journalism/master/labs/lab_05/data/county_pills_per_year.csv'
...
White_alone <- get_acs(geography = "state", 
              variables="B19013_001", year=2014, geometry = FALSE,  )
