...
# Load data and store it as an object called mingo called mingo
...
#Activis pharma to Miami-Luken to Strosnider
```
...
#I want to somehow and mutate the data to put all of the cardinal health-related companies in the same category, then use the data from the combined category to see how many drugs left the combined Cardinal facilities.
