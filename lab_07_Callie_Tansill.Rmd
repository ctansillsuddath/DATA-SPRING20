...
geo_pills_population_state_2009 %>%
  ...
  geom_sf(lwd = 0) +
  theme_map() +
  labs(fill='Pills per Person (2009)',title="Appalachia saw high rates of opioid shipments", subtitle = "In 2009, the number of opioids shipped per person was highest in West Virginia, Kentucky", caption = "Source: ARCOS database") +
...
geo_pills_population_state %>%
  ...
  geom_sf(lwd = 0) +
  theme_map() +
  labs(fill='Pills per Person',title="Pill shipments to the U.S. increase between 2006 and 2012", subtitle = "Pills per person shipped to each state in the U.S. between 2006 and 2012", caption = "Source: ARCOS database") +
  theme(legend.position="bottom") +
  scale_fill_viridis_c(option = "magma",labels = comma)
...
geo_pills_population_county_2009 <- county_geodata_shifted %>%
  left_join(pills_population_county_2009, by=c("GEOID" = "countyfips"))
...
geo_pills_population_county_maryland %>%
  ...
  geom_sf(lwd = 0) +
  theme_map() +
  labs(fill='Pills per Person',title="Pill shipments  increase between 2006 and 2012 in Maryland ", subtitle = "Pills per person shipped to Maryland counties between 2006 to 2012", caption = "Source: ARCOS database") +
  theme(legend.position="bottom") +
  scale_fill_viridis_c(option = "magma",labels = comma)
