...
#I have uploaded the data and named it
```
...
#My best guess is buyer_annual_by_year is higher than buyer_totals because... I think buyer_addresses is higher than buyer_totals
...
#VA CONSOLIDATED MAIL OUTPATIENT PHARMACY located in Charleston, SC had the most pills sent in total. I found this by cross-referencing the DEA number linked to the highest total pills in the graph below. I think the fact is a federal administration has something to do with how many pills it received.
```
